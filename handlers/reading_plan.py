...
def get_reading_plan_conversation_handler():
    """Return a ConversationHandler for setting up reading plans."""
    return ConversationHandler(
        entry_points=[MessageHandler(filters.Regex("(?i)^setup reading plan$"), start_plan)],
        states={
